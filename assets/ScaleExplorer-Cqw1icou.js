import{c as M}from"./vexflow-helper-BJ71SLUW.js";import{n as z,a as I,g as V,t as F,b as y,p as b,s as w,c as N}from"./index-Cb2-n-JM.js";var O={empty:!0,name:"",type:"",tonic:null,setNum:NaN,chroma:"",normalized:"",aliases:[],notes:[],intervals:[]};function A(e){if(typeof e!="string")return["",""];const t=e.indexOf(" "),n=I(e.substring(0,t));if(n.empty){const l=I(e);return l.empty?["",e.toLowerCase()]:[l.name,""]}const o=e.substring(n.name.length+1).toLowerCase();return[n.name,o.length?o:""]}var B=z;function L(e){const t=Array.isArray(e)?e:A(e),n=I(t[0]).name,o=V(t[1]);if(o.empty)return O;const l=o.name,r=n?o.intervals.map(s=>F(n,s)):[],u=n?n+" "+l:l;return{...o,name:u,type:l,tonic:n,notes:r}}const j=`<!-- src/tools/ScaleExplorer/ScaleExplorer.html -->
